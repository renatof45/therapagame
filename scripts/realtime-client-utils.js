...
rtclient.retrieveAllFiles = function(callback) {
    gapi.client.load('drive', 'v2', function() {
        ...
        var initialRequest = gapi.client.drive.files.list({
            'q': "mimeType='application/vnd.google-apps.drive-sdk.1083629863330'"
        });
...
rtclient.RealtimeLoader.prototype.redirectTo = function(fileIds, userId) {
  ...
  rtclient.params = rtclient.getParams();
    ...
    gapi.drive.realtime.load(fileIds, this.onFileLoaded, this.initializeModel, this.handleErrors);
...
rtclient.RealtimeLoader.prototype.start = function() {
    ...
    this.authorizer.start(function() {
        ...
        _this.load();
        //rtclient.retrieveAllFiles();
    });
}

rtclient.RealtimeLoader.prototype.listGroups = function(callback) {
    rtclient.retrieveAllFiles(function(groups) {
        callback(groups);
    });
}

rtclient.RealtimeLoader.prototype.getLastChange=function(callback){
    rtclient.getFileMetadata('0B6fSf_wQSV4MTU5UUlJReDdWS0U',function(resp){
         callback(resp);
    });
}
/**
